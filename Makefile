...
src/main/resources/com/t_oster/visicut/gui/resources/splash.png: splashsource.svg src/main/resources/com/t_oster/visicut/gui/resources/VisicutApp.properties
	./generatesplash.sh
jar: src/main/resources/com/t_oster/visicut/gui/resources/splash.png
	mvn package
clean:
	mvn clean
install:
